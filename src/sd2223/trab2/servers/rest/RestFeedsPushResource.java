...
import sd2223.trab2.servers.java.JavaFeedsPushRep;
...
public class RestFeedsPushResource extends RestFeedsResource<FeedsPush> implements FeedsServicePush {
	...
	public RestFeedsPushResource() {
		super(Args.contains("proxy") ? MastodonFeeds.getInstance() : Args.contains("rep") ? new JavaFeedsPushRep() : new JavaFeedsPush());
	}
