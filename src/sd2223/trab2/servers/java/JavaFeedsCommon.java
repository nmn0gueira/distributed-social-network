...
public abstract class JavaFeedsCommon<T extends Feeds> implements Feeds {
	protected static final long FEEDS_MID_PREFIX= 1_000_000_000;
	...
	protected record FeedInfo(String user, Set<Long> messages, Set<String> following, Set<String> followees) {
	...
	public record FeedUser(String user, String name, String pwd, String domain) {
